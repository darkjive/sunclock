/**
 * icons — Lucide-Icons (MIT/ISC) als Inline-SVG. Größe über font-size (1em),
 * Farbe über CSS 'color' (stroke=currentColor). Nur die Pfad-Innereien werden
 * gehalten; das SVG-Gerüst ist für alle Icons identisch (viewBox 0 0 24 24,
 * stroke-width 2, runde Enden).
 */
...
export const icon = (name: IconName): string =>
  `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${PATHS[name]}</svg>`;
