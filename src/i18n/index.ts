...
const de: Dict = {
  ...
  'chrono.cycles.title': 'Äußere Zyklen',
  'chrono.moon.illuminated': '{p} % beleuchtet',
  'chrono.moon.fullToday': 'heute Vollmond',
  'chrono.moon.dayToFull': 'morgen Vollmond',
  'chrono.moon.daysToFull': 'noch {d} Tage bis Vollmond',
  'chrono.moon.daySinceFull': 'Vollmond war gestern',
  'chrono.moon.daysSinceFull': 'Vollmond war vor {d} Tagen',
  'chrono.pressure.title': 'Luftdruck',
  'chrono.pressure.rising': 'steigend, {d} hPa in 3 h',
  'chrono.pressure.falling': 'fallend, {d} hPa in 3 h',
  'chrono.pressure.stable': 'stabil',
  'chrono.moon.disclaimer': 'Mondphase und Luftdruck stehen hier als äußere Zyklen neben deinem Rhythmus. Ein Zusammenhang mit Schlaf oder Befinden ist wissenschaftlich nicht belegt; die App zeigt die Werte, ohne sie zu bewerten.',
...
const en: Dict = {
  ...
  'chrono.cycles.title': 'External cycles',
  'chrono.moon.illuminated': '{p} % illuminated',
  'chrono.moon.fullToday': 'full moon today',
  'chrono.moon.dayToFull': 'full moon tomorrow',
  'chrono.moon.daysToFull': '{d} days to full moon',
  'chrono.moon.daySinceFull': 'full moon was yesterday',
  'chrono.moon.daysSinceFull': 'full moon was {d} days ago',
  'chrono.pressure.title': 'Air pressure',
  'chrono.pressure.rising': 'rising, {d} hPa over 3 h',
  'chrono.pressure.falling': 'falling, {d} hPa over 3 h',
  'chrono.pressure.stable': 'steady',
  'chrono.moon.disclaimer': 'Moon phase and air pressure appear here as external cycles alongside your rhythm. A link to sleep or wellbeing is not scientifically established; the app shows the values without judging them.',
